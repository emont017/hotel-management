...
<form action="register.php" method="POST" style="
    ...
    color: #ffffff;
">
    <label for="username" style="display:block; margin-bottom:8px;">Username <span style="color:red">*</span></label>
    <input type="text" id="username" name="username" required
        style="width: 100%; padding: 10px; border-radius: 8px; border: none; font-size: 1rem; margin-bottom: 20px; color: #081C3A;">

    <label for="password" style="display:block; margin-bottom:8px;">Password <span style="color:red">*</span></label>
    <input type="password" id="password" name="password" required
        style="width: 100%; padding: 10px; border-radius: 8px; border: none; font-size: 1rem; margin-bottom: 20px; color: #081C3A;">

    <label for="full_name" style="display:block; margin-bottom:8px;">Full Name <span style="color:red">*</span></label>
    <input type="text" id="full_name" name="full_name" required
        style="width: 100%; padding: 10px; border-radius: 8px; border: none; font-size: 1rem; margin-bottom: 20px; color: #081C3A;">

    <label for="email" style="display:block; margin-bottom:8px;">Email <span style="color:red">*</span></label>
